                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-header py-3">
                                <td><a href="#reportModal"  class="btn btn-success" data-toggle="modal"><span>Report</span></a></td>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <c:forEach var="r" items="${listRR}">
                                                <tr>                                            
                                                    <td>${r.content}</td>
                                                    <td>${r.purpose}</td>
                                                    <c:if test="${r.response == null}">
                                                       <td>Don't have Response</td>
                                                    </c:if>
                                                    <c:if test="${r.response != null}">   
                                                    <td><a class="btn btn-primary" href="viewresponse?id=${r.reportId}" role="button">View Response</a></td>
                                                    </c:if>
                                                </tr>
                                            </c:forEach>                                      
                                        </tbody>
